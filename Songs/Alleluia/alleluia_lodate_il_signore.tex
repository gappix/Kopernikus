...
\beginsong{Alleluia Lodate il Signore}[by={M. Frisina}] 	% <<< MODIFICA TITOLO E AUTORE
...
%---- Prima riga -----------------------------
\vspace*{-\versesep}
\[(A)] \[D] \[A] \[B-] \[F#-] % \[*D] per indicare le pennate, \rep{2} le ripetizioni
