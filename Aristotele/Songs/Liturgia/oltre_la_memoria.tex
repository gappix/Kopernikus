...
\beginsong{Oltre la memoria }[ititle={Symbolum 80}, by={\ifacinquevert \iftwocolumns Ma la tua parola - Symbolum 80 - \else Ma la tua parola — Symbolum 80 — \fi\fi  P. Sequeri}] 	% <<< MODIFICA TITOLO E AUTORE
