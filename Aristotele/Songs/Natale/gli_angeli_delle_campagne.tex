...
\beginsong{Gli angeli delle campagne}[by={Les anges dans nos campagnes — Autore ignoto}] 	% <<< MODIFICA TITOLO E AUTORE
\transpose{0} 						% <<< TRASPOSIZIONE #TONI (0 nullo)
\momenti{Natale}							% <<< INSERISCI MOMENTI	
% momenti vanno separati da ; e vanno scelti tra:
% Ingresso; Atto penitenziale; Acclamazione al Vangelo; Dopo il Vangelo; Offertorio; Comunione; Ringraziamento; Fine; Santi; Pasqua; Avvento; Natale; Quaresima; Canti Mariani; Battesimo; Prima Comunione; Cresima; Matrimonio; Meditazione; Spezzare del pane;
\ifchorded
	%\textnote{Tonalità unica }	% <<< EV COMMENTI (tonalità originale/migliore)
\fi
...
\ifchorded
	\textnote{$\lozenge$ Tonalità crescente}	% <<< EV COMMENTI (tonalità originale/migliore)
\fi
