...
\ifchorded
	\textnote{$\bigstar$ Tonalità migliore per le chitarre }	% <<< EV COMMENTI (tonalità originale/migliore)
\fi
...
\ifchorded
	\textnote{$\blacklozenge$ Tonalità originale}	% <<< EV COMMENTI (tonalità originale/migliore)
\fi
...
%%%%% STROFA
\beginverse*
\musicnote{Più leggero ma ritmato}
Per^chè tu ^solo il ^Santo, il Si^gnore,
tu ^solo l'Al^tissimo, ^Cristo G^esù
^con lo ^Spirito ^Santo nella ^gloria
del ^Pad\[C]re. \[G-] \[E&] \[C]
